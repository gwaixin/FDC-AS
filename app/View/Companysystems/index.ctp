		...
		<table class="table">
              <thead>
                <tr>
                  ...
                  <th>Status</th>
                  <th>
                 	 <a href="<?php echo $this->webroot; ?>companysystems/add" class="btn pull-right" ><i class="icon-plus-sign"></i> ADD</a>
                  </th>
                </tr>
              </thead>
              <tbody>
              ...
              ?>
                <tr class="role-id-<?php echo $row['Companysystem']['id'];?>">
                  ...
                  <td>
                  	...
                  	<a href="<?php echo $this->webroot; ?>companysystems/edit/<?php echo $row['Companysystem']['id']; ?>" class="btn btn-primary" data-role-id="<?php echo $row['Companysystem']['id'];?>">Edit</a>
                  </td>
                </tr>
            <?php
            	$num++;
